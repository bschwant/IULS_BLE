...
#define COPY_P2P_DATA_UUID(uuid_struct)          COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x43,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)

/**
 * Attribute modified +1 is based of service UUID
 * ex: Write is att_modified +1
 * ex: Notify is att_modified +2
 * ex: Data is att_modified+2
 */
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
    {
      ...
      switch(blecore_evt->ecode)
      {
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
       {
          ...
          APP_DBG_MSG("att mod %x", attribute_modified->Attr_Handle);
          APP_DBG_MSG("Before  %x",(aPeerToPeerContext.P2PWriteClientToServerCharHdle ) );
          APP_DBG_MSG("After +1 %x",(aPeerToPeerContext.P2PWriteClientToServerCharHdle + 1) );
          APP_DBG_MSG("Notify %x",(aPeerToPeerContext.P2PNotifyServerToClientCharHdle ) );
          APP_DBG_MSG("Notify +1 %x",(aPeerToPeerContext.P2PNotifyServerToClientCharHdle + 1) );
          APP_DBG_MSG("Notify +2 %x",(aPeerToPeerContext.P2PNotifyServerToClientCharHdle + 2) );
          APP_DBG_MSG("Data +2 %x",(aPeerToPeerContext.P2PSendDataCharHdle + 2) );
          
          // attribute_modified = (aci_gatt_attribute_modified_event_rp0*)blecore_evt->data;
          if(attribute_modified->Attr_Handle == (aPeerToPeerContext.P2PNotifyServerToClientCharHdle + 2))
            {
              APP_DBG_MSG("GATT: Notifcations Turned On");
              /**
               * Descriptor handle
               */
            ...
            {
              BLE_DBG_P2P_STM_MSG("-- GATT : COMMAND RECIEVED\n");
              Notification.P2P_Evt_Opcode = P2PS_STM_WRITE_EVT;
              Notification.DataTransfered.Length=attribute_modified->Attr_Data_Length;
              Notification.DataTransfered.pPayload=attribute_modified->Attr_Data;
              P2PS_STM_App_Notification(&Notification);  
            }
            else if(attribute_modified->Attr_Handle == (aPeerToPeerContext.P2PSendDataCharHdle + 2))
            {
              APP_DBG_MSG("GATT: Data notifcations Turned On");
               /**
               * Descriptor handle
               */
              return_value = SVCCTL_EvtAckFlowEnable;
...
void P2PS_STM_Init(void)
{
  ...
  SVCCTL_RegisterSvcHandler(PeerToPeer_Event_Handler);
    ...
    aci_gatt_add_service(UUID_TYPE_128,
                      ...
                      PRIMARY_SERVICE,
                      10,     // MUST INCREASE THIS FOR CUSTOM
    ...
    APP_DBG_MSG("ADDED P2P NOTIFY");  

    /**
     *  CUSTOM SERVICE ADDED FOR SENDING DATA
     * 
     **/

    COPY_P2P_DATA_UUID(uuid16.Char_UUID_128);
    aci_gatt_add_char(aPeerToPeerContext.PeerToPeerSvcHdle,
                      UUID_TYPE_128, &uuid16,
                      DATA_TRANSFER_NOTIFICATION_LEN_MAX,
                      CHAR_PROP_NOTIFY,
                      ...
                      10, /* encryKeySize */
                      1, /* isVariable: 1 */
                      &(aPeerToPeerContext.P2PSendDataCharHdle));
    APP_DBG_MSG("ADDED P2P DATA");
...
// static tBleStatus Data_Update_Char( sensordata_t *pDataValue )
// {
//   tBleStatus ret;
...
{
  APP_DBG_MSG("PAYLOAD: %s", (char* )pPayload);
