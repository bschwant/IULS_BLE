...
{
  /* IULS_BLE_Service */
  CUSTOM_STM_READ_WRITE_CHAR,
  CUSTOM_STM_INDICATION_CHAR,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* IULS_READ_WRITE_CHAR */
  CUSTOM_STM_READ_WRITE_CHAR_READ_EVT,
  CUSTOM_STM_READ_WRITE_CHAR_WRITE_NO_RESP_EVT,
  /* IULS_INDICATION_CHAR */
  CUSTOM_STM_INDICATION_CHAR_INDICATE_ENABLED_EVT,
  CUSTOM_STM_INDICATION_CHAR_INDICATE_DISABLED_EVT,
